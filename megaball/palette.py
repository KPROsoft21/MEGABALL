...
BLUE = [ pyxel.COLOR_NAVY, pyxel.COLOR_DARKBLUE, pyxel.COLOR_CYAN, pyxel.COLOR_WHITE ]
BROWN = [ pyxel.COLOR_BROWN, pyxel.COLOR_ORANGE, pyxel.COLOR_PEACH, pyxel.COLOR_WHITE ]
GREY = [ pyxel.COLOR_BLACK, pyxel.COLOR_DARKBLUE, pyxel.COLOR_GRAY, pyxel.COLOR_WHITE ]
